...
if (isset($_POST["checkout"])) {
  ...
  echo "<script>alert('Pemesanan Berhasil!! Team MarryYuk akan segera menghubungi anda melalui WA, untuk melanjutkan step berikutnya');</script>"; // tampilkan popup pemesanan berhasil
